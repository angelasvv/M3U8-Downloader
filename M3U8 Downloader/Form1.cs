...
namespace M3U8_Downloader
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Download()
        {
            ...
            {
                houzhui.Text = ".mp4";
                Command.Text = "-protocol_whitelist file,http,https,tcp,tls,crypto -i " + "\"" + textBox_Adress.Text + "\"" + " -c copy -y -bsf:a aac_adtstoasc " + "\"" + textBox_DownloadPath.Text + "\\" + textBox_Name.Text + ".mp4" + "\"";
            ...
            {
                houzhui.Text = ".mkv";
                Command.Text = "-protocol_whitelist file,http,https,tcp,tls,crypto -i " + "\"" + textBox_Adress.Text + "\"" + " -c copy -y -bsf:a aac_adtstoasc " + "\"" + textBox_DownloadPath.Text + "\\" + textBox_Name.Text + ".mkv" + "\"";
                RealAction("Tools\\ffmpeg.exe", Command.Text);
            }
            if (radioButton3.Checked == true)
            {
                houzhui.Text = ".ts";
                Command.Text = "-protocol_whitelist file,http,https,tcp,tls,crypto -i " + "\"" + textBox_Adress.Text + "\"" + " -c copy -y -f mpegts " + "\"" + textBox_DownloadPath.Text + "\\" + textBox_Name.Text + ".ts" + "\"";
                RealAction("Tools\\ffmpeg.exe", Command.Text);
            }
            if (radioButton4.Checked == true)
            {
                houzhui.Text = ".flv";
                Command.Text = "-protocol_whitelist file,http,https,tcp,tls,crypto -i " + "\"" + textBox_Adress.Text + "\"" + " -c copy -y -f f4v -bsf:a aac_adtstoasc " + "\"" + textBox_DownloadPath.Text + "\\" + textBox_Name.Text + ".flv" + "\"";
                RealAction("Tools\\ffmpeg.exe", Command.Text);
            }
        }
